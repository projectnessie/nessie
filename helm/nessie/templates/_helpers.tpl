...
{{- include "nessie.secretToEnv" (list .s3.accessKeySecret "awsAccessKeyId" "nessie.catalog.service.s3.default-options.access-key.name") }}
{{- include "nessie.secretToEnv" (list .s3.accessKeySecret "awsSecretAccessKey" "nessie.catalog.service.s3.default-options.access-key.secret") }}
...
{{- end -}}
{{- include "nessie.secretToEnv" (list .gcs.authCredentialsJsonSecret "key" "nessie.catalog.service.gcs.default-options.auth-credentials-json.key") }}
{{- include "nessie.secretToEnv" (list .gcs.oauth2TokenSecret "token" "nessie.catalog.service.gcs.default-options.oauth-token.token") }}
{{- include "nessie.secretToEnv" (list .gcs.oauth2TokenSecret "expiresAt" "nessie.catalog.service.gcs.default-options.oauth-token.expiresAt") }}
...
{{- end -}}
{{- include "nessie.secretToEnv" (list .adls.accountSecret "accountName" "nessie.catalog.service.adls.default-options.account.name") }}
{{- include "nessie.secretToEnv" (list .adls.accountSecret "accountKey" "nessie.catalog.service.adls.default-options.account.secret") }}
{{- include "nessie.secretToEnv" (list .adls.sasTokenSecret "sasToken" "nessie.catalog.service.adls.default-options.sas-token.key") }}
