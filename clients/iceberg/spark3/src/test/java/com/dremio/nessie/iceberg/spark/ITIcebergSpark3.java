...
class ITIcebergSpark3 extends AbstractSparkTest {
  ...
  @TempDir static File icebergLocalDir;
  ...
  void testSQL() {
    ...
    spark.sql(
        String.format("CREATE TABLE %s (id BIGINT NOT NULL, data STRING) USING iceberg", tableId));
    spark.sql(String.format("INSERT INTO %s VALUES (1, 'a'), (2, 'b'), (3, 'c')", tableId));
    List<Object[]> expected =
        ImmutableList.of(new Object[] {1L, "a"}, new Object[] {2L, "b"}, new Object[] {3L, "c"});
