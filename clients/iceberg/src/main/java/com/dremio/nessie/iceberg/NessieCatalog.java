...
public class NessieCatalog extends BaseMetastoreCatalog implements BranchCatalog, Closeable {
  ...
  @Override
  public com.dremio.nessie.iceberg.branch.Branch createBranch(String branchName,
                                                              String parentName) {
  ...
  @Override
  public com.dremio.nessie.iceberg.branch.Branch loadBranch(String branchName) {
