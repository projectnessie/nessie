...
class ITTestDefaultCatalogBranch extends BaseTestIceberg {
  ...
  public void testBasicBranch() throws NessieNotFoundException, NessieConflictException {
    ...
    Assertions.assertNotEquals(getContent(forwardCatalog, foobar), getContent(catalog, foobar));
    Assertions.assertNotEquals(getContent(forwardCatalog, foobaz), getContent(catalog, foobaz));
    ...
    Assertions.assertEquals(getContent(forwardCatalog, foobar), getContent(catalog, foobar));
    Assertions.assertEquals(getContent(forwardCatalog, foobaz), getContent(catalog, foobaz));
