...
public abstract class BaseTraceRawStore implements RawStore {
  ...
  public BaseTraceRawStore() {
    ...
    delegate = (RawStore) Proxy.newProxyInstance(NessieStoreImpl.class.getClassLoader(),
        new Class[]{RawStore.class}, new InvocationHandler() {
          ...
          public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (args == null) {
              ...
              System.out.print(String.format("%s(%s)", method.getName(), args.length == 0 ? "" :
                  Stream.of(args).map(o -> o == null ? null : o.toString()).collect(Collectors.joining(", "))));
            }
