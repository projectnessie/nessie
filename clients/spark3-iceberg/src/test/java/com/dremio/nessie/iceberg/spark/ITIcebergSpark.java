...
import static com.dremio.nessie.iceberg.NessieCatalog.CONF_NESSIE_AUTH_TYPE;
import static com.dremio.nessie.iceberg.NessieCatalog.CONF_NESSIE_REF;
import static com.dremio.nessie.iceberg.NessieCatalog.CONF_NESSIE_URL;
...
class ITIcebergSpark {
  ...
  static void create() throws IOException {
    ...
    spark = SparkSession.builder()
                        ...
                        .config("spark.sql.catalog.nessie", NessieIcebergSparkCatalog.class.getName())
                        .getOrCreate();
  ...
  static void tearDown() throws Exception {
    ...
    Reference reference = client.getTreeApi().getReferenceByName("main");
    client.getTreeApi().deleteBranch(reference.getName(), reference.getHash());
    client.close();
    catalog.close();
    catalog = null;
    if (spark != null) {
