...
public interface HttpContentsApi extends ContentsApi {
  ...
  Contents getContentsWithGlobalState(
      @Valid
          @Parameter(
  ...
  MultiGetContentsResponse getMultipleContentsWithGlobalState(
      @Pattern(regexp = Validation.REF_NAME_REGEX, message = Validation.REF_NAME_MESSAGE)
          @Parameter(
              description = "Reference to use. Defaults to default branch if not provided.",
              examples = {@ExampleObject(ref = "ref")})
      ...
      @Valid
          ...
          @RequestBody(
              ...
              content = @Content(mediaType = ApiVersions.APPLICATION_NESSIE_GLOBAL_STATE))
