...
public class User implements Base {
  ...
  public User(
    ...
    this(username, username, password, createMillis, active, email, roles, version, updateMillis);
  }
  ...
  public void setUpdateTime(long updateMillis) {
    this.updateMillis = updateMillis;
  }
  ...
  public boolean equals(Object o) {
    ...
    return createMillis == user.createMillis &&
      ...
      Objects.equal(updateMillis, user.updateMillis) &&
      Objects.equal(roles, user.roles);
  }

  @Override
  public int hashCode() {
    return Objects.hashCode(username, password, createMillis, active, email, roles, version, updateMillis);
  }
