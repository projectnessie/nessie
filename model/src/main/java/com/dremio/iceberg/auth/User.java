...
/**
 * Principal which defines what a user can do in Iceberg Alley.
 */
public final class User implements Principal {

  private final com.dremio.iceberg.model.User user;

  public User(com.dremio.iceberg.model.User user) {
    this.user = user;
  }
  ...
  com.dremio.iceberg.model.User unwrap() {
