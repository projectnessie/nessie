...
@WithKubernetesTestServer(setup = TestNessieReconcilerBigTable.Setup.class)
class TestNessieReconcilerBigTable extends AbstractReconcilerUnitTests<Nessie> {

  private static final String PREFIX = "/org/projectnessie/operator/tests/nessie/bigtable/";
