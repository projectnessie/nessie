...
public record BigTableOptions(
    ...
    @JsonPropertyDescription(
            """
            The BigTable credentials. When provided, it is assumed that authentication will use
            a service account JSON key. If left empty, then Workload Identity usage is assumed
            instead.""")
        @Nullable
        @jakarta.annotation.Nullable
        BigTableCredentials credentials) {
