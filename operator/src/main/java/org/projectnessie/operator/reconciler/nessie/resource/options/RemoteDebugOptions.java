...
public record RemoteDebugOptions(
    @JsonPropertyDescription("Whether to enable remote debugging.") @Default("false")
        Boolean enabled,
    @JsonPropertyDescription("The port to use for remote debugging.") @Default("5005") Integer port,
    @JsonPropertyDescription("Whether to suspend.") @Default("false") Boolean suspend) {
