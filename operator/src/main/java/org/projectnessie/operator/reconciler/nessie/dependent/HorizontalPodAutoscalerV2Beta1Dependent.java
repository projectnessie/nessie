...
import io.fabric8.kubernetes.api.model.autoscaling.v2beta1.HorizontalPodAutoscalerSpecBuilder;
...
public class HorizontalPodAutoscalerV2Beta1Dependent
  ...
  public HorizontalPodAutoscalerV2Beta1Dependent() {
    ...
    return new MetricSpecBuilder()
        ...
        .withResource(
            new ResourceMetricSourceBuilder()
                .withName(name)
                .withTargetAverageUtilization(percentage)
                .build())
        .build();
  }
  ...
  public static class ActivationCondition
    ...
    protected boolean isAutoscalingSupported(KubernetesHelper helper) {
      return helper.isAutoscalingV2Beta1Supported();
    }
  }
}
