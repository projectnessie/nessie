...
import org.projectnessie.operator.reconciler.nessie.resource.options.ServiceMonitorOptions;
...
public record NessieSpec(
    @JsonPropertyDescription(
        ...
        Integer size,
    @JsonPropertyDescription("The log level to use for the Nessie server.") @Default("INFO")
        LogLevel logLevel,
    @JsonPropertyDescription("Nessie version store options.") @Default("{}")
        VersionStoreOptions versionStore,
    @JsonPropertyDescription("Nessie service options.") @Default("{}") ServiceOptions service,
    @JsonPropertyDescription("Nessie ingress options.") @Default("{}") IngressOptions ingress,
    @JsonPropertyDescription("Nessie authentication options.") @Default("{}")
        AuthenticationOptions authentication,
    @JsonPropertyDescription("Nessie authorization options.") @Default("{}")
        AuthorizationOptions authorization,
    @JsonPropertyDescription("Nessie telemetry options.") @Default("{}") TelemetryOptions telemetry,
    @JsonPropertyDescription("Nessie ServiceMonitor (Prometheus) options.") @Default("{}")
        ServiceMonitorOptions serviceMonitor,
    @JsonPropertyDescription("Nessie autoscaling options.") @Default("{}")
        AutoscalingOptions autoscaling,
    @JsonPropertyDescription("Nessie remote debugging options.") @Default("{}")
    ...
    @JsonPropertyDescription(
            ...
            Any environment variable defined here will override all other \
            configuration properties and/or environment variables defined elsewhere, \
            or generated by this operator.""")
        @Default("[]")
  ...
  public NessieSpec {
    ...
    serviceMonitor = serviceMonitor != null ? serviceMonitor : new ServiceMonitorOptions();
    ...
    jvmOptions = jvmOptions != null ? List.copyOf(jvmOptions) : List.of();
