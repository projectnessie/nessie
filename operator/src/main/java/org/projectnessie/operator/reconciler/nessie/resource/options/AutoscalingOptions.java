...
public record AutoscalingOptions(
    @JsonPropertyDescription(
        ...
        @Default("false")
        Boolean enabled,
    @JsonPropertyDescription("The minimum number of replicas to maintain.") @Default("1") @Min(1)
        Integer minReplicas,
    @JsonPropertyDescription("The maximum number of replicas to maintain.") @Default("3") @Min(1)
        Integer maxReplicas,
    @JsonPropertyDescription(
