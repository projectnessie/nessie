...
import io.fabric8.kubernetes.api.model.autoscaling.v2beta2.CrossVersionObjectReferenceBuilder;
...
import io.fabric8.kubernetes.api.model.autoscaling.v2beta2.HorizontalPodAutoscalerSpecBuilder;
...
import io.fabric8.kubernetes.api.model.autoscaling.v2beta2.MetricTargetBuilder;
...
public class HorizontalPodAutoscalerV2Beta2Dependent
    extends AbstractHorizontalPodAutoscalerDependent<HorizontalPodAutoscaler> {

  public HorizontalPodAutoscalerV2Beta2Dependent() {
  ...
  public static class ActivationCondition
    ...
    protected boolean isAutoscalingSupported(KubernetesHelper helper) {
      return helper.isAutoscalingV2Beta2Supported();
    }
  }
}
