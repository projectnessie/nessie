...
public class CassandraContainerLifecycleManager
  ...
  protected CassandraContainer<?> createContainer() {
    return new CassandraContainer<>(
            ContainerImages.CASSANDRA.image().asCompatibleSubstituteFor("cassandra"))
        .withInitScript("org/projectnessie/operator/it/nessie/cassandra/init.cql")
  ...
  public void inject(TestInjector testInjector) {
    ...
    String contactPoint = inDockerIpAddress + ":" + CQL_PORT;
