...
|----------------|-----------------|----------------------------------------------------------------------|--------------|------------------------|-----------------------|
| 0.57.0         | 1.2.0           | 3.1.x (Scala 2.12), 3.2.x (Scala 2.12+2.13), 3.3.x (Scala 2.12+2.13) | n/a          | 1.14.x, 1.15.x, 1.16.x | 0.277, 0.278.x, 0.279 |
...
|----------------|---------------------------------|---------------|
| 0.57.0         | [Custom](#delta-lake-artifacts) | 3.2.X         |
