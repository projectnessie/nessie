...
|----------------|-----------------|----------------------------------------------------------------------|--------------|------------------------|-------------------------------------|
| 0.60.1         | 1.3.0           | 3.1.x (Scala 2.12), 3.2.x (Scala 2.12+2.13), 3.3.x (Scala 2.12+2.13) | n/a          | 1.14.x, 1.15.x, 1.16.x | 0.277, 0.278.x, 0.279, 0.280, 0.281 |
...
|----------------|---------------------------------|---------------|
| 0.60.1         | [Custom](#delta-lake-artifacts) | 3.2.X         |
