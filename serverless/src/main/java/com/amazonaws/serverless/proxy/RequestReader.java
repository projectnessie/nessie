...
/**
 * Implementations of the RequestReader object are used by container objects to transform the
 * incoming Lambda event into a request object that can be used by the underlying container.
 * Developers can build custom implementation of this interface to support other container types as
 * well as custom event types. This library provides a default implementation of this object that
 * supports requests for the AWS_PROXY integration.
 *
...
public abstract class RequestReader<RequestType, ContainerRequestType> {
  ...
  /**
   * The key for the <strong>API Gateway stage variables</strong> property in the PropertiesDelegate
   * object
   */
  ...
  /**
   * The key for the <strong>JAX RS security context</strong> properties stored in the request
   * attributes
   */
   ...
   * @param config          The container configuration object. This is passed in by the
   *                        LambdaContainerHandler.
   * @return A valid request object for the underlying container
   * @throws InvalidRequestEventException This exception is thrown if anything goes wrong during the
   *                                      creation of the request object
   */
  public abstract ContainerRequestType readRequest(RequestType request,
