...
/**
 * Implementation of Jersey's <code>Factory</code> object for <code>HttpServletRequest</code>
 * objects. This can be used by Jersey to generate a Servlet request given an
 * <code>AwsProxyRequest</code> event.
 *
 * <pre>
 * <code>
