...
/**
 * Implementations of this object are used by the container to transform the container's response
 * object into a valid return type for the AWS Lambda function. The <code>ContainerResponseType</code>
 * type could be a response model object or a <code>ResponseReader</code> implementation. For
 * example, the Jersey library passes the response reader object to the default implementation of
 * this class.
 *
...
public abstract class ResponseWriter<ContainerResponseType, ResponseType> {
   ...
   * @throws InvalidResponseObjectException When the implementation cannot read the container
   *                                        response object
   */
  public abstract ResponseType writeResponse(ContainerResponseType containerResponse,
