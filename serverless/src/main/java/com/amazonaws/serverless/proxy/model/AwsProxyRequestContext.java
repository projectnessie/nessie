...
/**
 * The API Gateway request context object. This is used by the default implementation of the
 * AWS_PROXY integration type. All of the values are part of the API Gateway $context variable so
 * this object could be reused with custom request readers.
 *
 * @see AwsProxyRequest
 * @see RequestReader
 */
