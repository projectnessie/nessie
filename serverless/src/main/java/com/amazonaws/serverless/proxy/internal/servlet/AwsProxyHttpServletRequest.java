...
/**
 * Implementation of the <code>HttpServletRequest</code> interface that supports
 * <code>AwsProxyRequest</code> object. This object is initialized with an
 * <code>AwsProxyRequest</code> event and a <code>SecurityContext</code> generated by an
 * implementation of the <code>SecurityContextWriter</code>.
 */
public class AwsProxyHttpServletRequest extends AwsHttpServletRequest {
  ...
  private static final Logger log = LoggerFactory.getLogger(com.amazonaws.serverless.proxy.internal.servlet.AwsProxyHttpServletRequest.class);
  ...
  public AwsProxyHttpServletRequest(AwsProxyRequest awsProxyRequest,
                                    Context lambdaContext,
                                    SecurityContext awsSecurityContext) {
    this(awsProxyRequest,
         lambdaContext,
         awsSecurityContext,
  ...
  public String getCharacterEncoding() {
    ...
    return parseCharacterEncoding(request.getMultiValueHeaders()
  ...
  public void setCharacterEncoding(String s)
    ...
    request.getMultiValueHeaders()
           .putSingle(HttpHeaders.CONTENT_TYPE, appendCharacterEncoding(currentContentType, s));
  }
  ...
  public String[] getParameterValues(String s) {
    List<String> values = new ArrayList<>(Arrays.asList(getQueryParamValues(request.getMultiValueQueryStringParameters(),
                                                                            s,
                                                                            config.isQueryStringCaseSensitive())));
