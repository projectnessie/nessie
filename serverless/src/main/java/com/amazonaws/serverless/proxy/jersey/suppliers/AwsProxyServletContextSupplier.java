...
/**
 * Implementation of Jersey's <code>Factory</code> object for <code>ServletContext</code> objects.
 * This can be used by Jersey to generate a Servlet context given an <code>AwsProxyRequest</code>
 * event.
 *
 * <pre>
 * <code>
...
public class AwsProxyServletContextSupplier implements Supplier<ServletContext> {
  ...
  private ServletContext getServletContext() {
    HttpServletRequest req = (HttpServletRequest) currentRequest.getProperty(
