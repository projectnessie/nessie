...
/**
 * Implementation of Jersey's <code>Factory</code> object for <code>HttpServletResponse</code>
 * objects. This can be used to write data directly to the servlet response for the method, without
 * using Jersey's <code>ContainerResponse</code>
 *
 * <pre>
 * <code>
