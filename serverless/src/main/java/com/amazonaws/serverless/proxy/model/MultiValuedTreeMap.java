 ...
 */
public class MultiValuedTreeMap<Key, Value> implements MultivaluedMap<Key, Value>, Serializable,
                                                       Cloneable {
  ...
  @Override
  public com.amazonaws.serverless.proxy.model.MultiValuedTreeMap<Key, Value> clone() {
    com.amazonaws.serverless.proxy.model.MultiValuedTreeMap<Key, Value> clone = new com.amazonaws.serverless.proxy.model.MultiValuedTreeMap<>();
    for (Key key : keySet()) {
