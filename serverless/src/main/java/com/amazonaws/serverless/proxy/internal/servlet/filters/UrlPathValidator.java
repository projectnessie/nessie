...
/**
 * Simple path validator filter. This is a default implementation to prevent malformed paths from
 * hitting the framework app. This applies to all paths by default
 */
...
public class UrlPathValidator implements Filter {
  ...
  private final Logger log = LoggerFactory.getLogger(com.amazonaws.serverless.proxy.internal.servlet.filters.UrlPathValidator.class);
