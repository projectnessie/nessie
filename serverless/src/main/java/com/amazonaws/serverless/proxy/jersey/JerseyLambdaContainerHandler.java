...
/**
 * Jersey-specific implementation of the <code>LambdaContainerHandler</code> interface. Given a
 * Jax-Rs application starts Jersey's <code>ApplicationHandler</code> and proxies requests and
 * responses using the RequestReader and ResponseWriter objects. The reader and writer objects are
 * inherited from the <code>BaseLambdaContainerHandler</code> object.
 *
 * <pre>
 * {@code
 ...
 */
public class JerseyLambdaContainerHandler<RequestType, ResponseType> extends
  ...
  private final JerseyHandlerFilter jerseyFilter;
  ...
  /**
   * Private constructor for a LambdaContainer. Sets the application object, sets the
   * ApplicationHandler, and initializes the application using the <code>onStartup</code> method.
   *
  ...
  /**
   * Returns an initialized <code>JerseyLambdaContainerHandler</code> that includes
   * <code>RequestReader</code> and
   * <code>ResponseWriter</code> objects for the <code>AwsProxyRequest</code> and
   * <code>AwsProxyResponse</code>
   * objects.
   *
   * @param jaxRsApplication A configured Jax-Rs application object. For Jersey apps this can be the
   *                         default
   *                         <code>ResourceConfig</code> object
   * @return A <code>JerseyLambdaContainerHandler</code> object
   */
  public static com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<AwsProxyRequest, AwsProxyResponse> getAwsProxyHandler(
    Application jaxRsApplication) {
    com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<AwsProxyRequest, AwsProxyResponse> newHandler = new com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<>(
   ...
   * Returns an initialized <code>JerseyLambdaContainerHandler</code> that includes
   * <code>RequestReader</code> and
   * <code>ResponseWriter</code> objects for the <code>HttpApiV2ProxyRequest</code> and
   * <code>AwsProxyResponse</code>
   * objects.
   *
   * @param jaxRsApplication A configured Jax-Rs application object. For Jersey apps this can be the
   ...
   * @return A <code>JerseyLambdaContainerHandler</code> object
   */
  public static com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<HttpApiV2ProxyRequest, AwsProxyResponse> getHttpApiV2ProxyHandler(
    Application jaxRsApplication) {
    com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<HttpApiV2ProxyRequest, AwsProxyResponse> newHandler = new com.amazonaws.serverless.proxy.jersey.JerseyLambdaContainerHandler<>(
  ...
  @Override
  protected AwsHttpServletResponse getContainerResponse(HttpServletRequest request,
  ...
  public void initialize() {
    ...
    FilterRegistration.Dynamic jerseyFilterReg = getServletContext().addFilter("JerseyFilter",
                                                                               jerseyFilter);
