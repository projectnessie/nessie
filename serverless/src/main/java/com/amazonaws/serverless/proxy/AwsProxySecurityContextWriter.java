...
/**
 * Default implementation of <code>SecurityContextWriter</code>. Creates a SecurityContext object
 * based on an API Gateway event and the Lambda context. This returns the default
 * <code>AwsProxySecurityContext</code> instance.
 */
