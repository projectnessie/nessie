...
/**
 * This class contains utility methods to address FSB security issues found in the application, such
 * as string sanitization and file path validation.
 */
public final class SecurityUtils {

  private static final Logger log = LoggerFactory.getLogger(com.amazonaws.serverless.proxy.internal.SecurityUtils.class);
  ...
  /**
   * Returns an absolute file path given an input path and validates that it is not trying to
   * write/read from a directory other than /tmp.
   *
