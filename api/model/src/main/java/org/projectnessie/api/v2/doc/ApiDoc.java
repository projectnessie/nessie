...
public interface ApiDoc {
  ...
  String BRANCH_DESCRIPTION =
      "A reference to a particular version of the contents tree (a point in history) on a branch.\n"
          ...
          + "- -*2021-04-07T14:42:25.534748Z - The predecessor commit from the HEAD of the default branch for the given ISO-8601 timestamp.\n"
          + "- name*2021-04-07T14:42:25.534748Z - The predecessor commit from the HEAD of a branch or tag valid for the given ISO-8601 timestamp.\n"
          + "- name*1685185847230 - The predecessor commit from the HEAD of a branch or tag valid for the given timestamp in milliseconds since epoch.\n"
          + "\n"
