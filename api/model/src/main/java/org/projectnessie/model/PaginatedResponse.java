...
public interface PaginatedResponse {
   ...
   * releases.
   *
   * @return paging continuation token for the next invocation of an API function supporting
   *     pagination, if {@link #isHasMore()} is {@code true}. Undefined, if {@link #isHasMore()} is
   *     {@code false}.
   */
  @Nullable
  @Size(min = 1)
