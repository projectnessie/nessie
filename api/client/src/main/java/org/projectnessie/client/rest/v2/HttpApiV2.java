...
public class HttpApiV2 implements NessieApiV2 {
  ...
  public String toPathString(ContentKey key) {
    return isNessieSpec220() ? key.toPathStringEscaped() : key.toPathStringControlChars();
  }
  ...
  public GetAllReferencesBuilder getAllReferences() {
    return new HttpGetAllReferences(client, this);
  }
  ...
  public GetCommitLogBuilder getCommitLog() {
    return new HttpGetCommitLog(client, this);
  }
