...
public class BasicUserService implements UserService {
  ...
  public User validate(String token) {
    ...
    return new User(new com.dremio.iceberg.model.User(
      claims.getBody().getSubject(),
      null,
      0,
      true,
      null,
      Sets.newHashSet(((String) claims.getBody().get("roles")).split(",")),
      null,
      0
    ));
  }
  ...
  public Optional<User> fetch(String username) {
    ...
    return Optional.of(new User(new com.dremio.iceberg.model.User(
      username,
      null,
      0,
      true,
  ...
  public List<User> fetchAll() {
    return USERS.keySet().stream().map(u -> new User(new com.dremio.iceberg.model.User(
      u,
      null,
      0,
      true,
