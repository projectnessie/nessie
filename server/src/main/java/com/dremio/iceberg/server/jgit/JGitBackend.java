...
public class JGitBackend {
  ...
  public VersionedWrapper<GitContainer> getRaw(String objectId) {
  ...
  public boolean atomicSwap(Ref oldRef, Ref newRef) {
    ...
    try {
      ...
      throw new IllegalStateException(
        "Unable to complete commit and update Ref " + newGitRef.getObj().getRef(), e);
    }
    return true;
  }
  ...
  public void putAll(Set<GitContainer> transactionSet) {
