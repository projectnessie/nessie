...
public interface JGitContainer {
  ...
  void add(String branch, Map<String, Map<String, String>> tables) throws Throwable;
  ...
  void commit(String branch, String tableName, BranchTable table) throws IOException;
}
