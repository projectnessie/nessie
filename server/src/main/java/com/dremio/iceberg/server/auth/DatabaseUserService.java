...
public class DatabaseUserService implements UserService {
  ...
  public Optional<User> fetch(String username) {
    ...
    if (user != null) {
      return Optional.of(Users.fromUser(user));
    }
  ...
  public List<User> fetchAll() {
    return backend.getAll(false).stream().map(Users::fromUser).collect(Collectors.toList());
  }
  ...
  public void create(User user) {
    ...
    com.dremio.iceberg.model.User withPassword = modelUser.withPassword(hashedPassword);
    backend.create(user.getName(), withPassword);
  }
  ...
  public void update(User user) {
    ...
    if (!check(modelUser.getPassword(), oldUser.getPassword())) {
      String hashedPassword = hash(modelUser.getPassword());
      modelUser = modelUser.withPassword(hashedPassword);
    }
