...
public class NessieRepository extends DfsRepository {
  ...
  public static class Builder
    ...
    private EntityBackend<GitContainer> backend;

    public Builder setBackend(EntityBackend<GitContainer> backend) {
  ...
  protected NessieRepository(DfsRepositoryBuilder builder) {
    super(builder);
    this.backend = new JGitBackend(((Builder) builder).backend);
