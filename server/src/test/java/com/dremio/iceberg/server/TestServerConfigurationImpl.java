...
public class TestServerConfigurationImpl implements ServerConfiguration {
  ...
  public TestServerConfigurationImpl(@JsonProperty("databaseBackend") ServerDatabaseConfigurationImpl databaseBackend,
                                     @JsonProperty("authorizationBackend") ServerAuthenticationConfigurationImpl authorizationBackend,
  ...
  public static class ServerAuthenticationConfigurationImpl implements ServerAuthenticationConfiguration {
    ...
    public ServerAuthenticationConfigurationImpl(@JsonProperty("userServiceClassName") String userServiceClassName,
