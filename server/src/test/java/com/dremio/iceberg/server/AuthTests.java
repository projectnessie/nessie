...
public class AuthTests {
  ...
  public void testAdmin() {
    ...
    tryEndpointPass(() -> client.getTableClient().createObject(Table.table("x", "x")));
    ...
    Table newTable = client.getTableClient().getObject("x");
  ...
  public void testUser() {
    ...
    tryEndpointFail(() -> client.getTableClient().createObject(Table.table("y", "x")));
