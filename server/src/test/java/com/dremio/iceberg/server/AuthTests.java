...
public class AuthTests {
  ...
  public void testAdmin() {
    ...
    tryEndpointPass(() -> client.getTableClient().createObject(create("x", "x")));
  ...
  public void testUser() {
    ...
    tryEndpointFail(() -> client.getTableClient().createObject(create("y", "x")));
  ...
  private Table create(String name, String location) {
