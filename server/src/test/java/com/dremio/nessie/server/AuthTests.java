...
public class AuthTests {
  ...
  public void getCatalog(String username, String password) {
    ...
    hadoopConfig.set("nessie.url", "http://localhost:9993");
  ...
  private BranchTable createTable(String name, String location) {
