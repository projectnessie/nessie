...
def assign_branch(base_url: str, branch: str, assign_to_json: dict, old_hash: Optional[str], ssl_verify: bool = True) -> None:
    ...
    _put(base_url + url, assign_to_json, ssl_verify=ssl_verify, params=params)


def assign_tag(base_url: str, tag: str, assign_to_json: dict, old_hash: Optional[str], ssl_verify: bool = True) -> None:
