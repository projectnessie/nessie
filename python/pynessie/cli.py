...
@click.option(
    ...
    "entry.contentType in ['ICEBERG_SNAPSHOT','DELTA_LAKE_TABLE']\n"
    "entry.namespace.startsWith('some.name.space') && entry.contentType in ['ICEBERG_SNAPSHOT','DELTA_LAKE_TABLE']\n",
)
