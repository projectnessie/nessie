 ...
 */
package org.projectnessie.restcatalog.server.json;

import com.fasterxml.jackson.databind.ObjectMapper;
import javax.enterprise.context.ApplicationScoped;
import javax.inject.Singleton;
import org.projectnessie.restcatalog.util.Json;
...
public class IcebergObjectMapperProducer {
   ...
   *
   * <p>We already produce this specific mapper through {@link
   * org.projectnessie.restcatalog.ee.javax.ContextObjectMapper}. But unfortunately,
   * ContextResolver @Provider-annotated classes are a JAX-RS mechanism, and sometimes they are not
   * picked up by the CDI container, for example in {@link
