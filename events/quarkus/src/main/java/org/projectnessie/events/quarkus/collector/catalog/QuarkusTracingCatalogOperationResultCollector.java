...
public class QuarkusTracingCatalogOperationResultCollector
    implements Consumer<CatalogOperationResult> {

  public static final String NESSIE_RESULTS_SPAN_NAME = "nessie.catalog-results";
  public static final AttributeKey<String> NESSIE_RESULT_TYPE_ATTRIBUTE_KEY =
      AttributeKey.stringKey("nessie.catalog-results.type");
  ...
  private final Consumer<CatalogOperationResult> delegate;
  private final String userName;
  private final Tracer tracer;

  public QuarkusTracingCatalogOperationResultCollector(
      Consumer<CatalogOperationResult> delegate, String userName, Tracer tracer) {
  ...
  public void accept(CatalogOperationResult result) {
    Span span =
        tracer
            ...
            .setAttribute(
                NESSIE_RESULT_TYPE_ATTRIBUTE_KEY, result.getOperation().getContentType().name())
