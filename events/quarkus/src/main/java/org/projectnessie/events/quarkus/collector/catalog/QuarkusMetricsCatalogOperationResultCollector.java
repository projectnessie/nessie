...
public class QuarkusMetricsCatalogOperationResultCollector
    extends QuarkusCatalogOperationResultCollector {

  /** The total number of results collected from the Version Store, exposed as a counter. */
  public static final String NESSIE_RESULTS_TOTAL = "nessie.catalog-results.total";

  /**
   * The total number of results rejected by the collector, based on the event type filters exposed
   * by the subscribers.
   */
  public static final String NESSIE_RESULTS_REJECTED = "nessie.catalog-results.rejected";

  private final MeterRegistry registry;

  public QuarkusMetricsCatalogOperationResultCollector(
