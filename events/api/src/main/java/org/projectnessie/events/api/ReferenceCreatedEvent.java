...
@tools.jackson.databind.annotation.JsonSerialize(as = ImmutableReferenceCreatedEvent.class)
@tools.jackson.databind.annotation.JsonDeserialize(as = ImmutableReferenceCreatedEvent.class)
