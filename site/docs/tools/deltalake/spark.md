...
also include `org.projectnessie.nessie-integrations:nessie-spark-3.2-extensions:{{ versions.java }}` and
...
=== "Java"
    ...
    conf.set("spark.jars.packages",
            "org.projectnessie.nessie-integrations:nessie-deltalake:{{ versions.java }},org.projectnessie.nessie-integrations:nessie-spark-3.2-extensions:{{ versions.java }}")
