...
Nessie does not make copies of your underlying data. Instead, it works by versioning 
...
Google BigTable, Apache Cassandra, PostgreSQL (incl. Cockroach), MariaDB, MySQL, and local storage using
RocksDB.
...
* Get started with the Nessie [quickstart](./try-nessie.md).
