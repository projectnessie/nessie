...
!!! note
    ...
    MariaDB and MySQL (experimental at the moment). For MySQL servers, use a JDBC URL with prefix
    `jdbc:mariadb` – the Nessie GC tool does not support `jdbc:mysql` JDBC URLs.
