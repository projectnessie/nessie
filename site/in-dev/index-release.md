...
=== "GitHub Container Registry"
    ...
    docker run -p 19120:19120 ghcr.io/projectnessie/nessie-server-admin:::NESSIE_VERSION:: --help
    ```
=== "Quay.io"
    ...
    docker run -p 19120:19120 quay.io/projectnessie/nessie-server-admin:::NESSIE_VERSION:: --help
    ```
