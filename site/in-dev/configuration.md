...
| SQL Server       | experimental, feedback welcome                   | `JDBC2` & `JDBC` (deprecated)                       | Use the Microsoft JDBC driver with a `jdbc:sqlserver://` URL and the Quarkus SQL Server datasource extension (included in Nessie server and GC tool distributions).                                                                                                                                                                                                           |
