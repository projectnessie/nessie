...
public class CommitBuilder<ValueT, StateT, MetadataT, EnumT extends Enum<EnumT>> {
  ...
  public CommitBuilder<ValueT, StateT, MetadataT, EnumT> put(
      String key, ValueT value, StateT state) {
    return put(Key.of(key), value, state);
  }
   ...
   * @return the builder instance
   */
  public CommitBuilder<ValueT, StateT, MetadataT, EnumT> put(Key key, ValueT value, StateT state) {
    return add(Put.of(key, value, state, null));
  }
