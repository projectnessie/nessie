 ...
 * {@link org.projectnessie.versioned.store.Store} implementation.
 * <p>
...
public interface L1 extends BaseValue<L1> {
   ...
   * <p>Must be called exactly once.</p>
   *
   * @param ids The list of ids. List must be {@link org.projectnessie.versioned.impl.InternalL1#SIZE} in length.
   * @return This consumer.
   */
