...
@tools.jackson.databind.annotation.JsonSerialize(as = ImmutableVersionedTestObj.class)
@tools.jackson.databind.annotation.JsonDeserialize(as = ImmutableVersionedTestObj.class)
