...
public class TestCommitsIterator {
  ...
  private static final Commit<String, String> FIRST_COMMIT =
      new Commit<String, String>(Commit.NO_ANCESTOR, "initial commit", Collections.emptyList());
  private static final Commit<String, String> SECOND_COMMIT =
      new Commit<String, String>(HASH_OF_1, "2nd commit", Collections.emptyList());
  private static final Commit<String, String> THIRD_COMMIT =
      new Commit<String, String>(HASH_OF_2, "3rd commit", Collections.emptyList());
  private static final Commit<String, String> FOURTH_COMMIT =
      new Commit<String, String>(HASH_OF_3, "4th commit", Collections.emptyList());
