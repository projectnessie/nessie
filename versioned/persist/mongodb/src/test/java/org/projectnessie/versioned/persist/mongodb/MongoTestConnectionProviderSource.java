...
public class MongoTestConnectionProviderSource
    implements TestConnectionProviderSource<MongoDatabaseClient> {
  ...
  private MongoDatabaseClient connectionProvider;
  ...
  public void start() throws Exception {
    ...
    connectionProvider = new MongoDatabaseClient();
  ...
  @Override
  public DatabaseAdapterConfig<MongoDatabaseClient> updateConfig(
      DatabaseAdapterConfig<MongoDatabaseClient> config) {
