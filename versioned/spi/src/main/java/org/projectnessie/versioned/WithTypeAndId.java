 ...
 */
@Value.Immutable
public interface WithTypeAndId<T, E extends Enum<E>> {
   ...
   */
  public static <T, E extends Enum<E>> WithTypeAndId<T, E> of(E type, T value, String id) {
    return ImmutableWithTypeAndId.<T, E>builder().type(type).value(value).currentId(id).build();
  }
}
