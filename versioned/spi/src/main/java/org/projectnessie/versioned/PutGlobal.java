 ...
 */
@Value.Immutable
public interface PutGlobal<V> extends Operation<V> {
   ...
   */
  @Nonnull
  public static <V> PutGlobal<V> of(@Nonnull Key key, @Nonnull V value) {
    return ImmutablePutGlobal.<V>builder().key(key).value(value).build();
  }
}
