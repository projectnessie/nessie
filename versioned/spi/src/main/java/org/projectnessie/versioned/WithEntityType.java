...
/**
 * A wrapper class that allows a value to be returned with an associated type.
 *
...
public interface WithEntityType<T> {
  ...
  /**
   * Build a WithEntityType object of type T.
   * @param <T> The value type to hold
   * @param entityType The entity type of this value.
