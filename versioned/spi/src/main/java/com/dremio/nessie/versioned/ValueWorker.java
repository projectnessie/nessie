...
public interface ValueWorker<VALUE, ASSET_KEY extends AssetKey<?>> extends Serializer<VALUE> {

  /**
   * Get a stream of assets associated with a particular value.
   * @return The asset keys associated with this value (if any).
   */
  Stream<VALUE> getAssetKeys(VALUE value);
   ...
   * @return
   */
  Serializer<ASSET_KEY> getAssetKeySerializer();
