...
class L1 extends MemoizedId {
  ...
  Id generateId() {
    return Id.build(h -> {
      h.putBytes(metadataId.getValue().asReadOnlyByteBuffer());
      h.putBytes(parentId.getValue().asReadOnlyByteBuffer());
  ...
  static final TableSchema<L1> SCHEMA = new SimpleSchema<L1>(L1.class) {
