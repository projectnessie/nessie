...
import org.projectnessie.catalog.secrets.azure.AzureSecretsSupplier;
...
@Dependent
@SecretsType(SecretsSupplierType.AZURE)
public class AzureSecretsSupplierBuilder implements SecretsSupplierBuilder {
  ...
  public SecretsSupplier buildSupplier() {
    ...
    return new AzureSecretsSupplier(client, prefix, secretsConfig.getSecretTimeout());
  }
}
