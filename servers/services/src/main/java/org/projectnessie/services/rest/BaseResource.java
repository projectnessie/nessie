...
abstract class BaseResource {
  ...
  private final VersionStore<Contents, GlobalContents, CommitMeta, Contents.Type> store;
  ...
  NamedRef namedRefOrThrow(String ref) throws NessieNotFoundException {
    return (NamedRef) namedRefWithHashOrThrow(ref).getValue();
  }
  ...
  Optional<NamedRef> optionalNamedRefOrThrow(String ref) throws NessieNotFoundException {
    ...
    return Optional.of((NamedRef) namedRefWithHashOrThrow(ref).getValue());
  }
  ...
  protected VersionStore<Contents, GlobalContents, CommitMeta, Contents.Type> getStore() {
    return store;
  }
