...
import static org.projectnessie.server.config.VersionStoreConfig.VersionStoreType.DYNAMO_OLD;
...
@StoreType(DYNAMO_OLD)
@Dependent
public class DynamoOldVersionStoreFactory implements VersionStoreFactory {
  ...
  @Inject
  public DynamoOldVersionStoreFactory(
