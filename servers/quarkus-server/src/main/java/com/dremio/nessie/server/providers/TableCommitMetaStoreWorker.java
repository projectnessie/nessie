...
@Singleton
public class TableCommitMetaStoreWorker implements StoreWorker<Contents, CommitMeta, NoOpAssetKey> {
  private static final ObjectMapper MAPPER = new ObjectMapper();

  private final ValueWorker<Contents, NoOpAssetKey> tableSerializer = new TableValueWorker();
  private final Serializer<CommitMeta> metaSerializer = new MetadataSerializer();

  @Override
  public ValueWorker<Contents, NoOpAssetKey> getValueWorker() {
  ...
  private static class TableValueWorker implements ValueWorker<Contents, NoOpAssetKey> {
    ...
    @Override
    public Stream<Contents> getAssetKeys(Contents value) {
      return Stream.of();
    }
