...
class TestGrpc extends AbstractTestRest {
  ...
  /**
   * The purpose of this is to force a restart of the Quarkus server, because other subclasses of
   * {@link AbstractTestRest} and {@link TestGrpc} effectively create the same branches.
   */
