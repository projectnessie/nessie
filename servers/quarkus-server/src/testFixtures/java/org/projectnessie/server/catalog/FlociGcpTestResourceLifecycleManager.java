...
import org.projectnessie.testing.floci.gcp.FlociGcpContainer;

public class FlociGcpTestResourceLifecycleManager implements QuarkusTestResourceLifecycleManager {

  private final FlociGcpContainer gcs = new FlociGcpContainer().withStartupAttempts(5);
