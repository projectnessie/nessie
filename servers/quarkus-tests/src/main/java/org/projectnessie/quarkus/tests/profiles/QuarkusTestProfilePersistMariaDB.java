...
public class QuarkusTestProfilePersistMariaDB extends BaseConfigProfile {
  ...
  public List<TestResourceEntry> testResources() {
    return ImmutableList.of(new TestResourceEntry(MariaDBTestResourceLifecycleManager.class));
  }
}
