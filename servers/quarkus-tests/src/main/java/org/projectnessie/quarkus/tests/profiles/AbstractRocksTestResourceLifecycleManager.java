...
abstract class AbstractRocksTestResourceLifecycleManager
    implements QuarkusTestResourceLifecycleManager {
  private final String configName;
  private Path rocksDir;

  AbstractRocksTestResourceLifecycleManager(String configName) {
  ...
  public Map<String, String> start() {
    ...
    String dbPath = rocksDir.toAbsolutePath().toString();
    return ImmutableMap.of(configName, dbPath);
  }
