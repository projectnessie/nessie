...
/**
 * Helper class to locate a JDK by Java major version and return the path to the {@code java} executable.
 */
public final class JavaVM {
   ...
   * than or equal to the requested {@code majorVersion}.</p>
  ...
  public static JavaVM findJavaVM(int majorVersion) {
    ...
    for (int i = majorVersion; i < MAX_JAVA_VERSION_TO_CHECK; i++) {
      JavaVM jvm = findJavaVMTryExact(i);
      if (jvm != null) {
        return jvm;
      }
    }
   ...
   * <p>Searches for the Java-Home in these places in this exact order:</p>
   * <ol>
   *   <li>Environment variable {@code JDKxx_HOME}, where {@code xx} is the {@code majorVersion}.</li>
   *   <li>Environment variable {@code JAVAxx_HOME}, where {@code xx} is the {@code majorVersion}.</li>
   *   <li>System property {@code jdkXX.home}, where {@code XX} is the {@code majorVersion}.</li>
   *   <li>System property {@code javaXX.home}, where {@code XX} is the {@code majorVersion}.</li>
   *   <li>Using the {@code /usr/libexec/java_home} on MacOS, which may return a newer Java version.</li>
   * </ol>
  ...
  public static JavaVM findJavaVMTryExact(int majorVersion) {
    ...
    String home = locateJavaHome(majorVersion, System::getenv, System::getProperty, ver -> {
      try {
        ...
        return new BufferedReader(
            new InputStreamReader(proc.getInputStream(), Charset.defaultCharset())).readLine();
      } catch (IOException e) {
        return null;
      }
    });
  ...
  /**
   * Extracts the major version from a Java-version-string as returned from
   * {@code System.getProeprty("java.version)}.
