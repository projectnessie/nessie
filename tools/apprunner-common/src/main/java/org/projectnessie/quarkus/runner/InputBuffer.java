...
final class InputBuffer {
  ...
  /**
   * Drains the input passed to the constructor until there's no more data to read, captures full lines
   * terminated with a {@code LF}) and pushes these lines to the consumer passed into the constructor.
