...
public class Tag implements Base {
  ...
  public static Tag fromModelTag(VersionedWrapper<com.dremio.iceberg.model.Tag> oldVersionedTag) {
    com.dremio.iceberg.model.Tag oldTag = oldVersionedTag.getObj();
    Tag tag = new Tag(oldTag.getName(),
                      ...
                      oldTag.getId(),
                      oldTag.isDeleted(),
                      oldTag.tableSnapshotKeys().stream()
                            .collect(Collectors.toMap(Function.identity(),
                                                      oldTag::getTableSnapshot)),
                      oldTag.getBaseTag(),
  ...
  @DynamoDbIgnore
  public VersionedWrapper<com.dremio.iceberg.model.Tag> toModelTag() {
    return new VersionedWrapper<>(new com.dremio.iceberg.model.Tag(
      name,
      uuid,
      createMillis,
      expireMillis,
