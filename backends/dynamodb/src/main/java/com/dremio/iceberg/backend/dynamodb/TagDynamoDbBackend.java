...
public class TagDynamoDbBackend
  ...
  public TagDynamoDbBackend(DynamoDbClient client, DynamoDbEnhancedClient mapper) {
    super(client, mapper, Tag.class, "IcebergAlleyTag");
  }

  @Override
  protected Tag toDynamoDB(VersionedWrapper<com.dremio.iceberg.model.Tag> from) {
    return Tag.fromModelTag(from);
  }

  @Override
  protected VersionedWrapper<com.dremio.iceberg.model.Tag> fromDynamoDB(Tag from) {
