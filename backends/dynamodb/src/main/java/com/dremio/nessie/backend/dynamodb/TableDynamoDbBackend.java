...
import com.dremio.nessie.backend.dynamodb.model.Table;
...
public class TableDynamoDbBackend
    extends AbstractEntityDynamoDbBackend<Table, com.dremio.nessie.model.Table> {
  ...
  @Override
  protected Table toDynamoDB(VersionedWrapper<com.dremio.nessie.model.Table> from) {
    return Table.fromModelTable(from);
  }

  @Override
  protected VersionedWrapper<com.dremio.nessie.model.Table> fromDynamoDB(Table from) {
