...
public class InMemory implements Backend {
  ...
  public static class TableInMemory implements EntityBackend<Table> {
    private static final Map<String, VersionedWrapper<Table>> TABLES = Maps.newHashMap();
    ...
    @Override
    public List<VersionedWrapper<Table>> getAll(boolean includeDeleted) {
      return getAll(null, includeDeleted);
    }

    @Override
    public List<VersionedWrapper<Table>> getAll(String namespace, boolean includeDeleted) {
  ...
  public static class TagInMemory implements EntityBackend<Tag> {
    ...
    @Override
    public List<VersionedWrapper<Tag>> getAll(boolean includeDeleted) {
      return getAll(null, includeDeleted);
    }

    @Override
    public List<VersionedWrapper<Tag>> getAll(String namespace, boolean includeDeleted) {
