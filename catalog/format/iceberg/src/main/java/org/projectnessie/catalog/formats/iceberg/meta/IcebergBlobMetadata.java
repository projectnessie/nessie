...
public interface IcebergBlobMetadata {
  ...
  static Builder builder() {
    return ImmutableIcebergBlobMetadata.builder();
  }

  static IcebergBlobMetadata blobMetadata(
      String type,
      long snapshotId,
      long sequenceNumber,
      List<Integer> fields,
      Map<String, String> properties) {
    return ImmutableIcebergBlobMetadata.of(type, snapshotId, sequenceNumber, fields, properties);
  }
