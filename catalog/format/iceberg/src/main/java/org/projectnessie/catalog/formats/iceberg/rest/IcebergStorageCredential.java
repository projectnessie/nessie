...
public interface IcebergStorageCredential {
  /**
   * Indicates a storage location prefix where the credential is relevant. Clients should choose the
   * most specific prefix (by selecting the longest prefix) if several credentials of the same type
   * are available.
   */
  String prefix();
