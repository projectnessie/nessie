...
public interface IcebergSnapshotLogEntry {
  static Builder builder() {
    return ImmutableIcebergSnapshotLogEntry.builder();
  }

  static IcebergSnapshotLogEntry snapshotLogEntry(long timestampMs, long snapshotId) {
    return ImmutableIcebergSnapshotLogEntry.of(timestampMs, snapshotId);
  }
