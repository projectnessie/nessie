...
public interface NessieIcebergBlobMetadata {
  ...
  static NessieIcebergBlobMetadata blobMetadata(
      String type, long sequenceNumber, List<Integer> fields, Map<String, String> properties) {
    return ImmutableNessieIcebergBlobMetadata.of(type, sequenceNumber, fields, properties);
  }
