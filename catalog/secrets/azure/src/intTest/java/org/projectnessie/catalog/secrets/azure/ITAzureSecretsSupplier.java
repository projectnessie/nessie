...
public class ITAzureSecretsSupplier {
  private static final Logger LOGGER = LoggerFactory.getLogger(ITAzureSecretsSupplier.class);
  ...
  static LowkeyVaultContainer lowkeyVault =
      LowkeyVaultContainerBuilder.lowkeyVault(
              ContainerSpecHelper.builder()
                  .name("lowkey-vault")
                  .containerClass(ITAzureSecretsSupplier.class)
                  .build()
  ...
  public void azureSecrets() {
    ...
    AzureSecretsSupplier secretsSupplier =
        new AzureSecretsSupplier(client, "", Duration.ofMinutes(1));
