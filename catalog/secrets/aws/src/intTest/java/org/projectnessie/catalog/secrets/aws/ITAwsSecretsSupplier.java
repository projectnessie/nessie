...
public class ITAwsSecretsSupplier {
  private static final Logger LOGGER = LoggerFactory.getLogger(ITAwsSecretsSupplier.class);
  ...
  public void awsSecretsManager() {
    ...
    try (SecretsManagerClient client =
      ...
      AwsSecretsSupplier secretsSupplier =
          new AwsSecretsSupplier(client, "", Duration.ofMinutes(1));
